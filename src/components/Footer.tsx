        ...
        <div className="grid md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            ...
            <div className="flex flex-col gap-2 mt-6 text-sm text-muted">
              <a href="mailto:dropsdrops2005@gmail.com" className="flex items-center gap-2 hover:text-accent-cyan transition-colors">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                dropsdrops2005@gmail.com
              </a>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="mailto:dropsdrops2005@gmail.com" className="block py-2 text-sm text-muted hover:text-white transition-colors">dropsdrops2005@gmail.com</a></li>
              <li><a href="mailto:dropsdrops2005@gmail.com" className="block py-2 text-sm text-muted hover:text-white transition-colors">Soporte DMCA</a></li>
