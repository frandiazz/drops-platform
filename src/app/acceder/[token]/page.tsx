      ...
      <>
        ...
        <main className="min-h-screen pt-24 pb-16 flex items-center justify-center">
          <div className="text-center max-w-md mx-auto px-4">
            ...
            <p className="text-xs text-muted mb-6"><a href="mailto:dropsdrops2005@gmail.com" className="text-accent-cyan hover:underline">Contactanos</a> para renovar.</p>
          </div>
        </main>
        <Footer />
      </>
      ...
      <>
        ...
        <main className="min-h-screen pt-24 pb-16 flex items-center justify-center">
          <div className="max-w-sm mx-auto px-4 text-center">
            ...
            <p className="text-xs text-muted mt-6">¿No recordás tu email? <a href="mailto:dropsdrops2005@gmail.com" className="text-accent-cyan hover:underline">Contactanos</a></p>
          </div>
        </main>
        <Footer />
      </>
      ...
      <main className="min-h-screen pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="glass-card rounded-xl p-6 text-center">
            ...
            <p className="text-xs text-muted">¿Dudas? <a href="mailto:dropsdrops2005@gmail.com" className="text-accent-cyan hover:underline">Contactanos</a></p>
          </div>
        </div>
      </main>
      <Footer />
