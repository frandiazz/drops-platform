        ...
        <section id="postularme" className="py-24 relative" aria-labelledby="cta-heading">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
            <div className="section-fade">
              ...
              <a href="/apply" className="inline-flex items-center px-10 py-4 bg-accent-violet text-white text-lg font-bold rounded-xl neon-glow hover:bg-violet-600 transition-all duration-300">
                Postularme Ahora
